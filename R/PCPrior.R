...
#' @title This calculates sigma such that if x~N(0,sigma^2) then l>= x0 with probability alpha
#' @description Calculates  the parameter sigma^2 such that if l~N(0,sigma^2) then x>x0 with probability alpha
#'
